...
@Component({
  selector: 'app-simple-with-bg-video',
  templateUrl: './simple-with-bg-video.component.html',
  styleUrls: ['./simple-with-bg-video.component.scss']
})
export class SimpleWithBgVideoComponent implements OnInit {
  seconds: number;
  interval:any
